...
witness = "ratamahatta"
backupsigningkey = "LLC6XXXXXX"                 # FALL BACK Hot Swappable Backup Signing Key
witnessurl = "https://localtalk.is/index.php/topic,24017.msg304832.html" # Your Witness Announcement url
...
websocket		= "wss://moscow.localcoin.is" #seednode to connect to!
seed_host               = "moscow.localcoin.is"    # hostname/ip for the public seed to monitor
seed_port               = 1776                  # port for the public seed to monitor (LocalCoin default = 1776)
